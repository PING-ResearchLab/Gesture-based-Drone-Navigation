...
velocity = 0.9
t_lat = 0.005
MIN_DISTANCE = (velocity*t_lat)+((velocity^2)/(2*1.5))*1.1
...
def rock(landmark_list, thumb_index_dist):
    return (
        get_angle(landmark_list[0], landmark_list[5], landmark_list[6]) > 120 and
        get_angle(landmark_list[5], landmark_list[6], landmark_list[8]) > 120 and
        #ut.get_distance([landmark_list[8], landmark_list[5]]) > 100 and
        get_angle(landmark_list[9], landmark_list[10], landmark_list[11]) < 130 and
        get_angle(landmark_list[13], landmark_list[14], landmark_list[15]) < 130 and
        get_angle(landmark_list[17], landmark_list[18], landmark_list[19]) > 120 and
        get_angle(landmark_list[0], landmark_list[17], landmark_list[18]) > 120
        #thumb_index_dist > 50
    )
 
def pinky(landmark_list, thumb_index_dist):
    return (
        get_angle(landmark_list[5], landmark_list[6], landmark_list[8]) < 130 and
        #ut.get_distance([landmark_list[8], landmark_list[5]]) > 100 and
        get_angle(landmark_list[9], landmark_list[10], landmark_list[11]) < 130 and
        get_angle(landmark_list[13], landmark_list[14], landmark_list[15]) < 130 and
        get_angle(landmark_list[17], landmark_list[18], landmark_list[19]) > 120 and
...
def hand_open(landmark_list, thumb_index_dist):
    return (
        ...
        get_angle(landmark_list[5], landmark_list[6], landmark_list[8]) > 120 and
        #ut.get_distance([landmark_list[8], landmark_list[5]]) > 100 and
        get_angle(landmark_list[9], landmark_list[10], landmark_list[11]) > 120 and
        get_angle(landmark_list[13], landmark_list[14], landmark_list[15]) > 120 and
        get_angle(landmark_list[17], landmark_list[18], landmark_list[19]) > 120 and
        thumb_index_dist > 50
    )
...
def three_fing(landmark_list, thumb_index_dist):
    return (
        ...
        get_angle(landmark_list[9], landmark_list[10], landmark_list[11]) > 120 and
        get_angle(landmark_list[13], landmark_list[14], landmark_list[15]) > 120 and
        get_angle(landmark_list[0], landmark_list[17], landmark_list[19]) > 120
    )
 
def hand_closed(landmark_list, thumb_index_dist):
    return (
        get_angle(landmark_list[5], landmark_list[6], landmark_list[7]) < 100 and
        get_angle(landmark_list[9], landmark_list[10], landmark_list[11]) < 100 and
        get_angle(landmark_list[13], landmark_list[14], landmark_list[15]) < 100 and
        get_angle(landmark_list[17], landmark_list[18], landmark_list[19]) < 100 and
        get_distance([landmark_list[4], landmark_list[17]]) < 225
    )
...
def point(landmark_list, thumb_index_dist):
    return (
        ...
        get_angle(landmark_list[13], landmark_list[14], landmark_list[15]) < 100 and
        get_angle(landmark_list[17], landmark_list[18], landmark_list[19]) < 100 #and
        #ut.get_angle(landmark_list[1], landmark_list[2], landmark_list[3]) < 100
        #thumb_index_dist > 50
    )
...
def peace(landmark_list, thumb_index_dist):
    return (
        get_angle(landmark_list[0], landmark_list[5], landmark_list[6]) > 120 and
        get_angle(landmark_list[5], landmark_list[6], landmark_list[8]) > 120 and
        get_angle(landmark_list[0], landmark_list[9], landmark_list[10]) > 120 and
        get_angle(landmark_list[9], landmark_list[10], landmark_list[11]) > 120 and
        get_angle(landmark_list[13], landmark_list[14], landmark_list[15]) < 100 and
        get_angle(landmark_list[17], landmark_list[18], landmark_list[19]) < 100 #and
        #ut.get_angle(landmark_list[1], landmark_list[2], landmark_list[3]) < 100
...
def fudge(landmark_list, thumb_index_dist):
    return (
        get_angle(landmark_list[5], landmark_list[6], landmark_list[8]) < 100 and
        get_angle(landmark_list[0], landmark_list[9], landmark_list[10]) > 120 and
        get_angle(landmark_list[9], landmark_list[10], landmark_list[11]) > 120 and
        get_angle(landmark_list[13], landmark_list[14], landmark_list[15]) < 100 and
        get_angle(landmark_list[17], landmark_list[18], landmark_list[19]) < 100
        #thumb_index_dist > 50
    )
...
def nice(landmark_list, thumb_index_dist):
    return (
        ...
        get_angle(landmark_list[0], landmark_list[9], landmark_list[10]) > 120 and
        get_angle(landmark_list[9], landmark_list[10], landmark_list[11]) > 120 and
        get_angle(landmark_list[0], landmark_list[13], landmark_list[14]) > 120 and
        get_angle(landmark_list[13], landmark_list[14], landmark_list[15]) > 120 and
        get_angle(landmark_list[0], landmark_list[17], landmark_list[18]) > 120 and
        get_angle(landmark_list[17], landmark_list[18], landmark_list[19]) > 120 and
        get_distance([landmark_list[4], landmark_list[8]]) < 70
        #ut.get_angle(landmark_list[1], landmark_list[2], landmark_list[3]) < 100
        #thumb_index_dist > 50
    )
...
# First get the info
                        ...
                        if magic == 0xBC:
                            ...
                            if format == 0:
                                ...
                                cv2.waitKey(1)    
                            video_rx_end = time.time()
                            print(f"[Latency] AI-deck video frame receive+decode time: {(video_rx_end - video_rx_start)*1000:.2f} ms")  
                        ...
                        if is_close(multi_ranger.front):
                            ...
                            add_obstacle_column(x_positions[-1]+MIN_DISTANCE, y_positions[-1]-.15, z_start=0, height=0.8)  # Add a column on the map
                            ...
                            # Add detection point to the plot
                            add_detection_point(x, y, z)
                            add_obstacle_column(x_positions[-1], y_positions[-1]+MIN_DISTANCE, z_start=0, height=0.8)  # Add a column on the map
                        ...
                        print(f"[Latency] Gesture recognition time: {(gesture_end_time - gesture_start_time)*1000:.2f} ms")
